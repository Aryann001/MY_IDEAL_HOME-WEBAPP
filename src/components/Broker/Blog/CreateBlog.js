...
export default function CreateBlog() {
  ...
  const { loading, error, success } = useSelector((state) => state.brokerBlog);
  ...
  const bannerSubmitHandler = (e) => {
    ...
    dispatch(createBlog(bannerData));
  };
      ...
      >
        <div className="banner">
          <div
            ...
            style={window.innerWidth <= Number(600) ? { height: "80vh" } : null}
          >
            <h1>Create Blog</h1>
            <form
